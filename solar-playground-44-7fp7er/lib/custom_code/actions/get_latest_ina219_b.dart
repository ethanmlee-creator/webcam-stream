...
Future<dynamic> getLatestIna219B() async {
  const String topCollection = 'sensorData';
  const String sensorDoc = 'ina219_B';
  const String readingsSubcollection = 'ina219_B_readings';
  ...
  try {
    ...
    return {
      ...
      'sensor': (d['sensor'] ?? 'ina219_B').toString(),
      'doc_id': doc.id,
    };
  } catch (e) {
