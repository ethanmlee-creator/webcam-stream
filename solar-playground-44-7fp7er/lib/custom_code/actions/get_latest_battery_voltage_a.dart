...
Future<dynamic> getLatestBatteryVoltageA() async {
  const String batteryCollection = 'batteries';
  const String batteryDoc = 'batteryA';
  const String readingsSubcollection = 'battA_percent';
  ...
  try {
    ...
    return {
      ...
      'battery_id': (d['battery_id'] ?? 'A').toString(),
      'doc_id': doc.id,
    };
  } catch (e) {
