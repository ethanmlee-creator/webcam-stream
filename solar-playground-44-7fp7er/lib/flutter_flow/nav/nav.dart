...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SensorDataWidget.routeName,
          path: SensorDataWidget.routePath,
          builder: (context, params) => SensorDataWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BatteryInformationWidget.routeName,
          path: BatteryInformationWidget.routePath,
          builder: (context, params) => BatteryInformationWidget(),
        )
